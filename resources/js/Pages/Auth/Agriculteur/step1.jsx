...
export default function AgriculteurStep1({ onNext, onBack, initialData = null }) {
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
                <InputLabel htmlFor="identifiant" value="Farm Identifier" />
                <TextInput
                    id="identifiant"
                    name="identifiant"
            ...
            <div>
                <InputLabel htmlFor="raison_sociale" value="Farm Name (Raison Sociale)" />
                <TextInput
                    id="raison_sociale"
                    name="raison_sociale"
            ...
            <div className="grid grid-cols-2 gap-4">
                <div>
                    <InputLabel htmlFor="telephone_exploitation" value="Farm Phone" />
                    <TextInput
            ...
            <div>
                <InputLabel htmlFor="adresse_ligne" value="Farm Address" />
                <TextInput
                    id="adresse_ligne"
                    name="adresse_ligne"
